...
) 
{
    ...
    if (opp_k6_dat0_stride != args[0].dat->set->set_capacity) {
        ...
        cutilSafeCall(hipMemcpyToSymbol(HIP_SYMBOL(opp_k6_dat0_stride_d), &opp_k6_dat0_stride, sizeof(OPP_INT)));
    }
    if (opp_k6_dat1_stride != args[1].dat->set->set_capacity) {
        opp_k6_dat1_stride = args[1].dat->set->set_capacity;
        cutilSafeCall(hipMemcpyToSymbol(HIP_SYMBOL(opp_k6_dat1_stride_d), &opp_k6_dat1_stride, sizeof(OPP_INT)));
    }
    if (opp_k6_map0_stride != args[2].size) {
        opp_k6_map0_stride = args[2].size;
        cutilSafeCall(hipMemcpyToSymbol(HIP_SYMBOL(opp_k6_map0_stride_d), &opp_k6_map0_stride, sizeof(OPP_INT)));
    }
    ...
    if (iter_size > 0) 
    {
        ...
        {
            if (opp_k6_sr_set_stride != set->size) {
                opp_k6_sr_set_stride = set->size;
                cutilSafeCall(hipMemcpyToSymbol(HIP_SYMBOL(opp_k6_sr_set_stride_d), &opp_k6_sr_set_stride, sizeof(OPP_INT)));
            }
