...
) 
{
    ...
    if (opp_k4_dat1_stride != args[4].dat->set->set_capacity) {
        opp_k4_dat1_stride = args[4].dat->set->set_capacity;
        cutilSafeCall(cudaMemcpyToSymbol(opp_k4_dat1_stride_d, &opp_k4_dat1_stride, sizeof(OPP_INT)));
    }
    if (opp_k4_dat2_stride != args[5].dat->set->set_capacity) {
        opp_k4_dat2_stride = args[5].dat->set->set_capacity;
        cutilSafeCall(cudaMemcpyToSymbol(opp_k4_dat2_stride_d, &opp_k4_dat2_stride, sizeof(OPP_INT)));
    }
    if (opp_k4_map0_stride != args[0].size) {
        opp_k4_map0_stride = args[0].size;
        cutilSafeCall(cudaMemcpyToSymbol(opp_k4_map0_stride_d, &opp_k4_map0_stride, sizeof(OPP_INT)));
    }
