...
) 
{
    ...
    if (thread_id + start < end) {
        ...
        } while (opp_k4::opp_part_check_status_cuda(move_flag, iter_one_flag, opp_p2c, n, 
...
) 
{
    ...
    if (opp_k4_c2c_map_stride != c2c_stride) {
        ...
        cutilSafeCall(cudaMemcpyToSymbol(opp_k4_c2c_map_stride_d, &opp_k4_c2c_map_stride, sizeof(OPP_INT)));
    }
    ...
    do 
    {
        ...
        if (opp_k4_dat3_stride != args[3].dat->set->set_capacity) {
            ...
            cutilSafeCall(cudaMemcpyToSymbol(opp_k4_dat3_stride_d, &opp_k4_dat3_stride, sizeof(OPP_INT)));
        }
