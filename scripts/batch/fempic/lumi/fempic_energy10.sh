#!/bin/bash -l
#SBATCH --job-name=fem_10             # Job name
#SBATCH --output=fem_energy10.o%j           # Name of stdout output file
#SBATCH --error=fem_energy10.e%j            # Name of stderr error file
