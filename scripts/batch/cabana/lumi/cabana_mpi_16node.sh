...
#SBATCH --job-name=cab_16            # Job name
#SBATCH --output=cab_16.o%j          # Name of stdout output file
#SBATCH --error=cab_16.e%j           # Name of stderr error file
...
#         sed -i "s/INT nz = 30/INT nz = 3840/" ${currentfilename}
#         sed -i "s/INT num_part_per_cell = 1500/INT num_part_per_cell = ${config}/" ${currentfilename}
