...
#SBATCH --job-name=cab_2             # Job name
#SBATCH --output=cab_2.o%j           # Name of stdout output file
#SBATCH --error=cab_2.e%j            # Name of stderr error file
...
#         sed -i "s/INT nz = 30/INT nz = 480/" ${currentfilename}
#         sed -i "s/INT num_part_per_cell = 1500/INT num_part_per_cell = ${config}/" ${currentfilename}
