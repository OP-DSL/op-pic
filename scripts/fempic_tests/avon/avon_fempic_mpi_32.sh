...
binary="/home/dcs/csrcnj/phd/OP-PIC/fempic_mpi/bin/mpi_hdf5_32"
...
for run in 1 2; do
    for config in 384000 768000 1536000 3072000 6144000; do
        ...
        sed -i "s/STRING hdf_filename = \/home\/dcs\/csrcnj\/phd\/box_mesh_gen\/hdf5\/box_96000.hdf5/STRING hdf_filename = \/home\/dcs\/csrcnj\/phd\/box_mesh_gen\/hdf5_32\/box_${config}.hdf5/" ${currentfilename}
